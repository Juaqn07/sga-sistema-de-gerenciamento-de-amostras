...
<html lang="pt-BR">
  <head>
    ...
    <link rel="stylesheet" href="../css/criar-processo.css" />
  </head>
  <body>
    <!-- Header -->
    <header>
      ...
      <div class="row g-4">
          ...
          <form class="bg-white p-4 rounded shadow-sm">
            ...
            <div class="mb-3">
              ...
              <input
                type="text"
                class="form-control"
                placeholder="Ex: Análise de Qualidade - Lote A123"
                required
              />
            </div>
            ...
            <div class="mb-3">
              ...
              <select class="form-select" required>
                <option selected>Pré-forma PET</option>
                <option>Garrafa Finalizada</option>
                <option>Tampa Plástica</option>
            ...
            <div class="row">
              <div class="col-md-6 mb-3">
                ...
                <input
                  type="text"
                  class="form-control"
                  placeholder="Ex: Galpão 5, Sala 101"
                />
              </div>
              <div class="col-md-6 mb-3">
            ...
            <div class="anexos mb-4 p-4 border border-2 border-secondary-subtle rounded text-center bg-light position-relative">
              ...
              <p class="mb-1">
                ...
                <a
                  href="#"
                  onclick="document.getElementById('formFileMultiple').click(); return false;"
                >
                  clique para selecionar
                </a>
              </p>
              <small class="text-muted">
                Suporta PDF, JPG, PNG, CSV até 50MB por arquivo
              </small>
            </div>
        ...
        <div class="col-lg-4">
          <div class="bg-white p-4 rounded shadow-sm mb-3">
            ...
            <p><strong>Criador:</strong><br />Administrador Sistema</p>
            <p><strong>Tipo de Transporte:</strong><br />Correios</p>
            <p>
          ...
          <div class="bg-light border p-3 rounded small">
            ...
            Após enviar, o processo receberá um número único e será encaminhado
            automaticamente para separação.
          </div>
        </div>
      </div>
    </div>
